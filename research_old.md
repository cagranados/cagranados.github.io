...
<p style="margin:0"> <a style="margin:0; font-size:100%; font-weight:bold" href="files/papers/VolSpilloversLatam.pdf">Prices Stability and Macroeconomic Volatility Spillovers in Latin America </a> <br><button class="accordion"> 
    Abstract   
    </button>   
